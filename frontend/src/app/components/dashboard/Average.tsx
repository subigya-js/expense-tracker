    ...
    return (
        <div className="flex flex-col space-y-4 p-6 bg-white shadow-md rounded-lg w-full min-h-[120px] border border-gray-300">
            ...
            <div className="flex justify-between">
                ...
                <p className="text-red-600 text-md font-semibold">Expenses: ₹{Number(expense.toFixed(2)).toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
            </div>
        </div>
    )
}
